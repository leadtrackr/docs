...
- **Compatible with the LeadTrackr tag** — shares the same [ChannelFlow cookies](/lead-sources/channel-flow-tracker#cookies-used-by-channelflow) and lead format, so the LeadBot and the [GTM tag](/lead-sources/gtm) can run side by side
